...
// TODO Gamepad support - egads, Unity makes that hard! Thinking of ditching this for:
// 		https://github.com/daemon3000/InputManager/wiki
namespace Spewnity
{
    ...
    {
        [HideInInspector]
        public string name; // Value is set automatically
